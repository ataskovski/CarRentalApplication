...
builder.Services.AddDefaultIdentity<CarRentalApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
...
builder.Services.AddHttpClient<IExternalCarApiService, ExternalCarApiService>();
